...
{
    public class MarkWordAsUknownValidatorTests
    {
        ...
        public MarkWordAsUknownValidatorTests()
        {
        ...
        public async Task Validate_Default_NoExceptions()
        {
            ...
            var command = new MarkWordAsUknownCommand(1, 2);
        ...
        private MarkWordAsUknownValidator MakeValidator(
            IUserContext userContext = null,
            IWordRules wordRules = null,
            IUserRules userRules = null
        )
        {
            return new MarkWordAsUknownValidator(
